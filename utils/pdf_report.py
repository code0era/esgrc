"""
RISK INTELL PDF Report Generator
Produces a professional, branded A4 PDF from the RISK INTELL performance context dict.
...
def _draw_header(canvas, doc):
    ...
    canvas.drawString(MARGIN, PAGE_H - 1.5 * cm, "🛡  RISK INTELL Platform")
...
def _draw_footer(canvas, doc):
    ...
    canvas.drawString(MARGIN, 0.4 * cm, f"Generated: {ts}  |  RISK INTELL Platform  |  Confidential")
    canvas.drawRightString(PAGE_W - MARGIN, 0.4 * cm, "© RISK INTELL")
    canvas.restoreState()
...
def generate_pdf(context: dict) -> bytes:
    """
    Build a professional A4 PDF report from the RISK INTELL context dict.
    ...
    doc = SimpleDocTemplate(
        ...
        title="RISK INTELL Performance Report",
    ...
    story.append(Paragraph(
        "This report was automatically generated by the RISK INTELL Platform using a "
