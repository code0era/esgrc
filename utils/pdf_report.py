"""
METEOERAIT SOFTWARE PDF Report Generator
Produces a professional, branded A4 PDF from the METEOERAIT SOFTWARE performance context dict.
...
def _draw_header(canvas, doc):
    ...
    canvas.drawString(MARGIN, PAGE_H - 1.5 * cm, "🛡  METEOERAIT SOFTWARE")
...
def _draw_footer(canvas, doc):
    ...
    canvas.drawString(MARGIN, 0.4 * cm, f"Generated: {ts}  |  METEOERAIT SOFTWARE  |  Confidential")
    canvas.drawRightString(PAGE_W - MARGIN, 0.4 * cm, "© METEOERAIT SOFTWARE")
    canvas.restoreState()
...
def generate_pdf(context: dict) -> bytes:
    """
    Build a professional A4 PDF report from the METEOERAIT SOFTWARE context dict.
    ...
    doc = SimpleDocTemplate(
        ...
        title="METEOERAIT SOFTWARE Performance Report",
    ...
    story.append(Paragraph(
        "This report was automatically generated by the METEOERAIT SOFTWARE using a "
