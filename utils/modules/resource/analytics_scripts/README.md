# Resource module analytics scripts

Data source: Repo-01 commit [`7abf094`](https://github.com/AI-ERMT-TBD-02/Repo-01/commit/7abf094)
(Praveen, 6 Aug 2026), which supplied `input_metric_values_resource.csv` and
`resource_performance_json_file.json`. Those two files are the only real inputs; they
live in `modules/resource/reference_data/`.
...
```
python pipeline/scripts/generate_module_scripts.py --module resource --camel Resource --dir Resource
```
