...
# -----------------------------
def build_metric_lookup(json_file_path='resource_performance_json_file.json'):
    """
...
# dump. Resource has 190 metrics (vs ESGRC's 84) and the correlation matrix dump
...
def main(metrics_csv_file_path, group_csv_file_path, sub_module_csv_file_path):
    ...
    json_path = 'resource_performance_json_file.json'  # Adjust path if needed
    ...
    # File names
    output_report_file = 'M_G_SM_correlation_report_resource.txt'
    trends_file = 'trends_and_repetitions_report_resource.txt'
    inconsistencies_file = 'inconsistencies_report_resource.txt'
    chaid_report_file = 'chaid_risk_segmentation_report_resource.txt'
...
if __name__ == "__main__":
    metrics_csv_file_path = 'filtered_metrics_data_resource.csv'
    group_csv_file_path = 'filtered_groups_data_resource.csv'
    sub_module_csv_file_path = 'filtered_sub_modules_data_resource.csv'
    ...
    ## After L0 this is updated for 'Resource' module in version 8.0 and adapted for all other modules from hereon. 24/01/2026
    ## Supercedes all versions of AI_Ready_Correlation_Analysis_Resource.py files.