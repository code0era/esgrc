...
if __name__ == "__main__":
    source_file = 'module_values_bspt.csv'
    json_file_path = 'bspt_performance_json_file.json'
    metrics_output_file = 'filtered_metrics_data_bspt.csv'
    groups_output_file = 'filtered_groups_data_bspt.csv'
    sub_modules_output_file = 'filtered_sub_modules_data_bspt.csv'
    risk_assessment_output_file = 'data_for_risk_assessment_bspt.csv'
