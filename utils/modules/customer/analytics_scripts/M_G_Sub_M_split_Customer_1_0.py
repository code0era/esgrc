...
if __name__ == "__main__":
    source_file = 'module_values_customer.csv'
    json_file_path = 'customer_performance_json_file.json'
    metrics_output_file = 'filtered_metrics_data_customer.csv'
    groups_output_file = 'filtered_groups_data_customer.csv'
    sub_modules_output_file = 'filtered_sub_modules_data_customer.csv'
    risk_assessment_output_file = 'data_for_risk_assessment_customer.csv'
