...
# -----------------------------
def build_metric_lookup(json_file_path='shared_performance_json_file.json'):
    """
...
# dump. Shared has 288 metrics (vs ESGRC's 84) and the correlation matrix dump
...
def main(metrics_csv_file_path, group_csv_file_path, sub_module_csv_file_path):
    ...
    json_path = 'shared_performance_json_file.json'  # Adjust path if needed
    ...
    # File names
    output_report_file = 'M_G_SM_correlation_report_shared.txt'
    trends_file = 'trends_and_repetitions_report_shared.txt'
    inconsistencies_file = 'inconsistencies_report_shared.txt'
    chaid_report_file = 'chaid_risk_segmentation_report_shared.txt'
...
if __name__ == "__main__":
    metrics_csv_file_path = 'filtered_metrics_data_shared.csv'
    group_csv_file_path = 'filtered_groups_data_shared.csv'
    sub_module_csv_file_path = 'filtered_sub_modules_data_shared.csv'
