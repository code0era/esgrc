...
if __name__ == "__main__":
    source_file = 'module_values_product.csv'
    json_file_path = 'product_performance_json_file.json'
    metrics_output_file = 'filtered_metrics_data_product.csv'
    groups_output_file = 'filtered_groups_data_product.csv'
    sub_modules_output_file = 'filtered_sub_modules_data_product.csv'
    risk_assessment_output_file = 'data_for_risk_assessment_product.csv'
