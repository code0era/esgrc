...
# -----------------------------
def build_metric_lookup(json_file_path='product_performance_json_file.json'):
    """
...
# dump. Product has 634 metrics (vs ESGRC's 84) and the correlation matrix dump
...
def main(metrics_csv_file_path, group_csv_file_path, sub_module_csv_file_path):
    ...
    json_path = 'product_performance_json_file.json'  # Adjust path if needed
    ...
    # File names
    output_report_file = 'M_G_SM_correlation_report_product.txt'
    trends_file = 'trends_and_repetitions_report_product.txt'
    inconsistencies_file = 'inconsistencies_report_product.txt'
    chaid_report_file = 'chaid_risk_segmentation_report_product.txt'
...
if __name__ == "__main__":
    metrics_csv_file_path = 'filtered_metrics_data_product.csv'
    group_csv_file_path = 'filtered_groups_data_product.csv'
    sub_module_csv_file_path = 'filtered_sub_modules_data_product.csv'
    ...
    ## After L0 this is updated for 'Product' module in version 8.0 and adapted for all other modules from hereon. 24/01/2026
    ## Supercedes all versions of AI_Ready_Correlation_Analysis_Product.py files.