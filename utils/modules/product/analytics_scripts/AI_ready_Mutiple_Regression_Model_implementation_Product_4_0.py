...
# -------------------------------
file_path = 'module_values_product.csv'
...
if duplicate_cols:
    ...
    raise ValueError("Duplicate column IDs found in module_values_product.csv. Please fix before analysis.")
else:
...
with open("product_performance_json_file.json", "r") as f:
...
# -------------------------------
X = metrics_data.drop(columns=['PROD_001'])
y = metrics_data['PROD_001']
input_dim = X.shape[1]
...
baseline_summary = (
    f"Baseline Predictor (Mean of PROD_001):\n"
    f"MSE: {baseline_mse}\n"
...
with open("Product_Module_model_summary.txt", "w") as f:
    f.write("\n".join(report_lines))
    ...
    f.write("\n")
    f.write("----------------------------------End of Product Module Risk Analysis Summary---------------------------\n")
print("Full analysis written to Product_Module_model_summary.txt")
