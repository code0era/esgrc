...
metrics_file = 'input_metric_values_ictm.csv'
json_file = 'ictm_performance_json_file.json'
...
def save_averages_to_csv(metric_data, group_averages, sub_module_averages, module_averages, output_csv_file):
    ...
    if module_id:
        ...
        new_columns['PRCY_001'] = module_avg_series
    ...
    print("Output file created with consolidated values and PRCY_001 column.")

# Define the output CSV file name
output_csv_file = 'module_values_ictm.csv'
...
def print_and_save_performance_averages(low_performing_metrics, low_performing_values, low_performing_groups, low_performing_group_values, low_performing_sub_modules, low_performing_sub_module_values, module_averages, json_data, output_report_file):
    ...
    print(f"\nOverall Module Average (PRCY_001): {module_average:.2f}")
...
output_report_file = 'low_performing_entities_report_ictm.txt'
...
##Module_values_ictm.csv retained as the output file. Version - 3_0
