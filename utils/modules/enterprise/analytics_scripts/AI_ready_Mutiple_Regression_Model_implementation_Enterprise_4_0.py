...
# -------------------------------
file_path = 'module_values_enterprise.csv'
...
if duplicate_cols:
    ...
    raise ValueError("Duplicate column IDs found in module_values_enterprise.csv. Please fix before analysis.")
else:
...
with open("enterprise_performance_json_file.json", "r") as f:
...
# -------------------------------
X = metrics_data.drop(columns=['ETPR_001'])
y = metrics_data['ETPR_001']
input_dim = X.shape[1]
...
baseline_summary = (
    f"Baseline Predictor (Mean of ETPR_001):\n"
    f"MSE: {baseline_mse}\n"
...
with open("Enterprise_Module_model_summary.txt", "w") as f:
    f.write("\n".join(report_lines))
    ...
    f.write("\n")
    f.write("----------------------------------End of Enterprise Module Risk Analysis Summary---------------------------\n")
print("Full analysis written to Enterprise_Module_model_summary.txt")
