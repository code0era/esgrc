...
# -----------------------------
def build_metric_lookup(json_file_path='integration_performance_json_file.json'):
    """
...
# dump. Integration has 90 metrics (vs ESGRC's 84) and the correlation matrix dump
...
def main(metrics_csv_file_path, group_csv_file_path, sub_module_csv_file_path):
    ...
    json_path = 'integration_performance_json_file.json'  # Adjust path if needed
    ...
    # File names
    output_report_file = 'M_G_SM_correlation_report_integration.txt'
    trends_file = 'trends_and_repetitions_report_integration.txt'
    inconsistencies_file = 'inconsistencies_report_integration.txt'
    chaid_report_file = 'chaid_risk_segmentation_report_integration.txt'
...
if __name__ == "__main__":
    metrics_csv_file_path = 'filtered_metrics_data_integration.csv'
    group_csv_file_path = 'filtered_groups_data_integration.csv'
    sub_module_csv_file_path = 'filtered_sub_modules_data_integration.csv'
    ...
    ## After L0 this is updated for 'Integration' module in version 8.0 and adapted for all other modules from hereon. 24/01/2026
    ## Supercedes all versions of AI_Ready_Correlation_Analysis_Integration.py files.