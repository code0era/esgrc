...
if __name__ == "__main__":
    source_file = 'module_values_integration.csv'
    json_file_path = 'integration_performance_json_file.json'
    metrics_output_file = 'filtered_metrics_data_integration.csv'
    groups_output_file = 'filtered_groups_data_integration.csv'
    sub_modules_output_file = 'filtered_sub_modules_data_integration.csv'
    risk_assessment_output_file = 'data_for_risk_assessment_integration.csv'
    ...
    # "data_for_risk_assessment_<module>.csv" is required for the Multi Variate Risk Assessment for the Module.
