...
# -------------------------------
file_path = 'module_values_brand.csv'
...
if duplicate_cols:
    ...
    raise ValueError("Duplicate column IDs found in module_values_brand.csv. Please fix before analysis.")
else:
...
with open("brand_performance_json_file.json", "r") as f:
...
# -------------------------------
X = metrics_data.drop(columns=['BRDM_001'])
y = metrics_data['BRDM_001']
input_dim = X.shape[1]
...
baseline_summary = (
    f"Baseline Predictor (Mean of BRDM_001):\n"
    f"MSE: {baseline_mse}\n"
...
with open("Brand_Module_model_summary.txt", "w") as f:
    f.write("\n".join(report_lines))
    ...
    f.write("\n")
    f.write("----------------------------------End of Brand Module Risk Analysis Summary---------------------------\n")
print("Full analysis written to Brand_Module_model_summary.txt")
