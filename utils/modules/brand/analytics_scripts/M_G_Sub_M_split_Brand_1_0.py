...
if __name__ == "__main__":
    source_file = 'module_values_brand.csv'
    json_file_path = 'brand_performance_json_file.json'
    metrics_output_file = 'filtered_metrics_data_brand.csv'
    groups_output_file = 'filtered_groups_data_brand.csv'
    sub_modules_output_file = 'filtered_sub_modules_data_brand.csv'
    risk_assessment_output_file = 'data_for_risk_assessment_brand.csv'
