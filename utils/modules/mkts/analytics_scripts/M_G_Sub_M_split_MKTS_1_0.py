...
if __name__ == "__main__":
    source_file = 'module_values_mkts.csv'
    json_file_path = 'mkts_performance_json_file.json'
    metrics_output_file = 'filtered_metrics_data_mkts.csv'
    groups_output_file = 'filtered_groups_data_mkts.csv'
    sub_modules_output_file = 'filtered_sub_modules_data_mkts.csv'
    risk_assessment_output_file = 'data_for_risk_assessment_mkts.csv'
