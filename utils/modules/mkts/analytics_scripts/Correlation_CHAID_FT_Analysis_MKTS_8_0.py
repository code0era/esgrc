...
# -----------------------------
def build_metric_lookup(json_file_path='mkts_performance_json_file.json'):
    """
...
# dump. MKTS has 192 metrics (vs ESGRC's 84) and the correlation matrix dump
...
def main(metrics_csv_file_path, group_csv_file_path, sub_module_csv_file_path):
    ...
    json_path = 'mkts_performance_json_file.json'  # Adjust path if needed
    ...
    # File names
    output_report_file = 'M_G_SM_correlation_report_mkts.txt'
    trends_file = 'trends_and_repetitions_report_mkts.txt'
    inconsistencies_file = 'inconsistencies_report_mkts.txt'
    chaid_report_file = 'chaid_risk_segmentation_report_mkts.txt'
...
if __name__ == "__main__":
    metrics_csv_file_path = 'filtered_metrics_data_mkts.csv'
    group_csv_file_path = 'filtered_groups_data_mkts.csv'
    sub_module_csv_file_path = 'filtered_sub_modules_data_mkts.csv'
    ...
    ## After L0 this is updated for 'MKTS' module in version 8.0 and adapted for all other modules from hereon. 24/01/2026
    ## Supercedes all versions of AI_Ready_Correlation_Analysis_MKTS.py files.